...
function getItems(req, res, next) {
    ...
    db.query("SELECT asdetect_contact__r__loyaltyid__c AS userId, type__c , description__c, name, createdDate, _hc_lastop,hc_err FROM salesforce.asdetect_interaction__c WHERE asdetect_contact__r__loyaltyid__c=$1 order by createdDate desc LIMIT 30", [externalUserId])
